...
class DashboardMain extends React.Component {
  ...
  render() {
    ...
    if (!Auth.retriveToken() || Auth.retriveToken() === 'undefined') {
      ...
      return (
        <div>
          <div style={{ backgroundColor: '#068FFF', padding: '30px' }}>
            <span style={{ color: '#fff', textDecoration: 'none', marginLeft: '10px' }}>Test Portal</span>
            <span onClick={() => (this.logout(this))}  style={{border: '1px solid #ffff',borderRadius:'4px', padding: '5px 6px', cursor: 'pointer',color: '#fff', textDecoration: 'none', marginRight: '10px', float: 'right' }}>Logout</span>
          </div>
          {/* <HomepageHeader title='Test Portal' /> */}
          ...
          <div className={this.props.classes.inlineblock}>
            ...
            <br />
            <br />
            <Button variant="contained" onClick={() => (this.handleTableExapand("Teacher"))}>Show</Button>
          ...
          <Button variant="contained" onClick={() => (this.handleTableExapand("Student"))}>Show</Button>
          ...
          <div className={this.props.classes.inlineblock}>
            ...
            <br />
            <br />
            <Button variant="contained" onClick={() => (this.handleTableExapand("Subject"))}>Show</Button>
